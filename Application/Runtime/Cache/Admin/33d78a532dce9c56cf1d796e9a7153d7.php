            ...
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-sitemap"></span> 部门列表
                    </div>
                            ...
                            <table class="am-table am-table-striped am-table-hover table-main ">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="table-title" style="width: 25%">部门名称</th> 
                                    ...
                                    <?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <a href="/tongxun3/index.php/Admin/Index/addnews/id/<?php echo ($v["id"]); ?>" style="width: 63px; height: 28px; margin-right: 10px" class="am-btn am-btn-primary am-btn-xs "><span class="am-icon-pencil-square-o"></span> 编辑</a>
                                                        <button onclick="del(<?php echo ($v["id"]); ?>)" class="am-btn am-btn-danger am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span> 删除</button>
                                                    </div>
                                                </div>
                                            </td>
