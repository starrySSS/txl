                ...
                <div class="tpl-block">
                    ...
                    <div class="am-g">
                        <div class="tpl-form-body tpl-form-line">
                            <form class="am-form tpl-form-line-form" action="/txl/index.php/Admin/Index/add/id/26" enctype="multipart/form-data" method="post">
                                    ...
                                    <div class="am-u-sm-9">
                                        <div class="am-form-group am-form-file">
                                            <div class="tpl-form-file-img">
                                                <?php if(!empty($home['touxiang'])): ?><img src="/txl/Public/<?php echo ($home["touxiang"]); ?>" alt=""><?php endif; ?>
                                            </div>
