...
<html>
			...
			<div class="contain">
				...
				<ul class="am-nav am-navbar-nav am-navbar-right">
					...
					<li class="hidden-xs am-hide-sm-only">
                        <form role="search" class="app-search" method="post" action="/tongxun3/index.php/Home/index/index.html">
                            <input type="text" placeholder="username..." class="form-control" name="search"> 
                             <input type="submit"  value="" style=" width:30px; height:30px;  border:0; background:url(/tongxun3/Public/Home/img/search.png) no-repeat left top;background-size: 24 24" />
                        </form>
                    </li>
				</ul>
			</div>
	...
	<!--	<div class="am-g">-->
				...
				<div class="am-g"> 
						<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="am-u-md-3 am-u-end">
							<div class="card-box widget-user">
                                <div>
                                    <img src="/tongxun3/Public/<?php echo ($v["touxiang"]); ?>" class="img-responsive img-circle" alt="user">
		...
		<script type="text/javascript" src="/tongxun3/Public/Home/js/charts/echarts.min.js" ></script>
		<script type="text/javascript" src="/tongxun3/Public/Home/js/charts/indexChart.js" ></script>
