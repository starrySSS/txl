...
.error-container{ background:#fff; border:1px solid #0ae;  text-align:center; width:450px; margin:180px auto; font-family:Microsoft Yahei; padding-bottom:30px; border-top-left-radius:5px; border-top-right-radius:5px;  }
...
<div class="error-container"> 
    ...
    <div class="errorcon">
        ...
        <?php }else{?>       
        <i class="icon-frown-o"></i><?php echo($error); ?>
        <?php }?>
   </div>
