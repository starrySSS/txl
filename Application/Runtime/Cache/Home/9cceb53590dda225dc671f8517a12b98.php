	...
	<!--	<div class="am-g">-->
		...
		<div class="content-page">
			...
			<!-- col start -->
				<div class="am-g">
					<div class="card-box"> 
						<form class="am-form am-form-horizontal" method="post" action="/tongxun/index.php/Home/Index/addCommonUser">  
					...
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="am-u-md-3 am-u-end">
							<div class="card-box widget-user">
                                <div>
                                    <img src="/tongxun/Public/<?php echo ($v["touxiang"]); ?>" class="img-responsive img-circle" alt="user"  style="width: 100px;height: 100px;">
                                    <div class="wid-u-info" style="margin-left: 10px;margin-top: 10px;">
                                        ...
                                        <small class="text-warning"><b>部门：<?php echo ($v["title"]); ?></b></small>  
                                         <h4 class="m-t-0 m-b-5 font-600"><a href="/tongxun/index.php/Home/Index/searchCommUser/userid/<?php echo ($v["id"]); ?>">添加到常用联系人</a></h4>
                                    </div>
                                </div>
                            </div>
